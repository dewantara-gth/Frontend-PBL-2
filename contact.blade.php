...
<body class="bg-white text-gray-800">
    ...
    <nav class="flex items-center justify-between p-4 border-b">
        ...
        <div class="hidden md:flex space-x-6">
            ...
            <a class="text-green-600 border-b-2 border-green-600" href="#">About Us</a>
            <a class="hover:text-green-600" href="#">Booking Now</a>
            <a class="hover:text-green-600" href="#">Contact Us</a>
        </div>
