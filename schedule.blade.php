...
<body class="bg-[#f9f9f9] text-[#1a1a1a]">
    <div class="flex min-h-screen flex-col md:flex-row">
        ...
        <div class="w-full md:w-64 bg-white shadow-md sidebar">
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center py-2 px-8 text-blue-700 hover:bg-gray-200" href="schedule.blade.php">
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-gray-800 bg-opacity-75 z-50 hidden">
        <div class="flex flex-col items-center justify-center h-full">
            ...
            <a class="fflex items-center py-2 px-8 text-white hover:bg-blue-200" href="booking_data.blade.php">
                <i class="fas fa-list-alt mr-3"></i>
                <span>Booking Data</span>
            </a>
            <a class="flex items-center py-2 px-8 text-blue-700 hover:bg-blue-200" href="schedule.blade.php">
                <i class="fas fa-calendar-alt mr-3"></i>
                <span>Schedule</span>
            </a>
